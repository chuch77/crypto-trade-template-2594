		...
		extend: {
			colors: {
				...
				gym: {
					...
					'text-light': 'hsl(var(--gym-text-light))',
					'text-muted': 'hsl(var(--gym-text-muted))'
				},
				sidebar: {
			...
			keyframes: {
				...
				'glow-pulse': {
					'0%, 100%': {
						boxShadow: '0 0 20px hsl(var(--gym-primary) / 0.3)'
					},
					'50%': {
						boxShadow: '0 0 40px hsl(var(--gym-primary) / 0.6)'
					}
				}
			},
			animation: {
