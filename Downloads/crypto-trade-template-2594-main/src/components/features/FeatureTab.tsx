  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 min-w-0">
        <div className={`${isActive ? 'text-primary' : 'text-muted-foreground'}`} aria-hidden="true">
          {icon}
        </div>
        <div className="text-left min-w-0">
          <h3 className={`font-semibold truncate text-base ${isActive ? 'text-primary' : ''}`} role="heading" aria-level={4}>
            {title}
          </h3>
